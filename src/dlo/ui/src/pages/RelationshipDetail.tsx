...
export function RelationshipDetail() {
  ...
  const relationship = name ? getRelationship(name) : undefined;
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground">
                {error?.message || `Relationship "${name}" not found`}
              </p>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 p-4 bg-muted rounded-lg">
                <div className="flex-1">
                  <Link to={`/models/${relationship.from}`} className="hover:underline">
                ...
                <div className="flex-1 text-right">
                  <Link to={`/models/${relationship.to}`} className="hover:underline">
                    <div className="font-medium text-foreground hover:text-primary transition-colors">
                      {relationship.to}
                    </div>
                  </Link>
            ...
            <div className="space-y-2">
              ...
              <code className="block text-xs bg-muted p-3 rounded-lg">
                {relationship.from}.{relationship.from_columns.join(', ')} = {relationship.to}.{relationship.to_columns.join(', ')}
              </code>
            </div>
